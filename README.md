...
The server should be restarted automatically and visit the metrics endpoint: http://localhost:9080/metrics
...
We now need to change the server configuration to externalize the ports.  In the `open-liberty-masterclass/start/barista/src/main/liberty/config/server.xml` file, change this line:
